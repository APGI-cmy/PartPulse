...
**ABSOLUTE PROHIBITION**: This agent is **PROHIBITED** from modifying its own contract file (`.github/agents/integration-builder.md`) under any circumstances.
...
**What This Means**:
- ✗ **PROHIBITED**: Writing to `.github/agents/integration-builder.md`
...
<!-- Lock ID: LOCK-INTEGRATION_BUILDER-STOP-AND-FIX-001 | Authority: STOP_AND_FIX_DOCTRINE.md Section 3.1, 3.2, 3.3 | Review: quarterly -->
...
**Complete When**: Scope matches arch, 100% QA green, gates satisfied, evidence ready, zero debt/warnings, build succeeds, integration tests pass, connectors validated, data flows tested, reports submitted, **ZERO DEPRECATED APIs**
