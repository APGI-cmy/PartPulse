...
**ABSOLUTE PROHIBITION**: This agent is **PROHIBITED** from modifying its own contract file (`.github/agents/api-builder.md`) under any circumstances.
...
**What This Means**:
- ✗ **PROHIBITED**: Writing to `.github/agents/api-builder.md`
...
<!-- Lock ID: LOCK-API_BUILDER-STOP-AND-FIX-001 | Authority: STOP_AND_FIX_DOCTRINE.md Section 3.1, 3.2, 3.3 | Review: quarterly -->
...
**Complete When**: Scope matches arch, 100% QA green, gates satisfied, evidence ready, zero debt/warnings, build succeeds, API tests pass, error handling tested, reports submitted, **ZERO DEPRECATED APIs**
...
| File Integrity Protection | AGENT_CONTRACT_PROTECTION_PROTOCOL.md Section 4.3 | CS2 | Reference-based (lines 1-242) |
