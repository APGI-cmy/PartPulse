...
**ABSOLUTE PROHIBITION**: This agent is **PROHIBITED** from modifying its own contract file (`.github/agents/qa-builder.md`) under any circumstances.
...
**What This Means**:
- ✗ **PROHIBITED**: Writing to `.github/agents/qa-builder.md`
